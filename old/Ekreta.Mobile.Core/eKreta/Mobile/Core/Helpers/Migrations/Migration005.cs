...
// Type: Ekreta.Mobile.Core.Helpers.Migrations.Migration005
...
{
  public class Migration005 : MigrationBase
  {
    internal override void Migrate(ISettings appSettings, ISecureStore secureStore = null)
    {
      ...
      {
        if (profile.NewItems != null)
          profile.NewItems["Lesson"] = new List<NewsItem>();
      }
