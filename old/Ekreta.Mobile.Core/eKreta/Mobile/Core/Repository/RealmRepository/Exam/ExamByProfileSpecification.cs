...
// Type: Ekreta.Mobile.Core.Repository.RealmRepository.Exam.ExamByProfileSpecification
...
{
  public class ExamByProfileSpecification : ProfileSpecification<ExamRealm>
  {
    public ExamByProfileSpecification(string profileId)
      : base(profileId)
    {
    }
