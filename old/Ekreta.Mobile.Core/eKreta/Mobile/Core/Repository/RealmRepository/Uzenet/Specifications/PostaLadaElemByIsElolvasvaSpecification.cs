...
// Type: Ekreta.Mobile.Core.Repository.RealmRepository.Uzenet.Specifications.PostaLadaElemByIsElolvasvaSpecification
...
{
  internal class PostaLadaElemByIsElolvasvaSpecification : ProfileSpecification<PostaladaElemRealm>
  {
    public PostaLadaElemByIsElolvasvaSpecification(string rolelessId)
      : base(rolelessId)
    {
    }
