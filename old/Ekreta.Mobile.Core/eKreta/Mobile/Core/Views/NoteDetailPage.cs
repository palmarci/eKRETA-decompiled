...
// Type: Ekreta.Mobile.Core.Views.NoteDetailPage
...
{
  [XamlFilePath("Views/NoteDetailPage.xaml")]
  [XamlCompilation]
  [MvxMasterDetailPagePresentation]
  public class NoteDetailPage : MvxContentPage<NoteDetailViewModel>
  {
    ...
    private void InitializeComponent()
    {
      ...
      resourceLoadingQuery.set_AssemblyName(typeof (NoteDetailPage).GetTypeInfo().Assembly.GetName());
      resourceLoadingQuery.set_ResourcePath("Views/NoteDetailPage.xaml");
      ...
      else
      {
        ...
        NameScope nameScope = (NameScope) (NameScope.GetNameScope((BindableObject) (noteDetailPage = this)) ?? (INameScope) new NameScope());
        NameScope.SetNameScope((BindableObject) noteDetailPage, (INameScope) nameScope);
        translateExtension1.Text = "NoteDetail_Page_Title";
        TranslateExtension translateExtension7 = translateExtension1;
        XamlServiceProvider xamlServiceProvider1 = new XamlServiceProvider();
        Type type1 = typeof (IProvideValueTarget);
        object[] objArray1 = new object[0 + 1];
        objArray1[0] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver1 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver1, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        ...
        ((Page) noteDetailPage).set_Title((string) obj2);
        ((BindableObject) noteDetailPage).SetValue((BindableProperty) Page.UseSafeAreaProperty, (object) true);
        ...
        objArray2[0] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver2 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver2, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        ...
        ((VisualElement) noteDetailPage).set_BackgroundColor((Color) obj4);
        ...
        objArray3[2] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver3 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver3, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        ...
        objArray4[3] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver4 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver4, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        ...
        bindingExtension1.set_Path("Note.Title");
        ...
        objArray5[3] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver5 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver5, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        ...
        objArray6[2] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver6 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver6, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        ...
        object obj12 = ((IMarkupExtension) resourceExtension22).ProvideValue((IServiceProvider) xamlServiceProvider6);
        ...
        objArray7[2] = (object) stackLayout2;
        objArray7[3] = (object) scrollView;
        objArray7[4] = (object) grid2;
        objArray7[5] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver7 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver7, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        xamlServiceProvider7.Add(type14, (object) xamlTypeResolver7);
        xamlServiceProvider7.Add(typeof (IXmlLineInfoProvider), (object) new XmlLineInfoProvider((IXmlLineInfo) new XmlLineInfo(39, 28)));
        object obj14 = ((IMarkupExtension) resourceExtension23).ProvideValue((IServiceProvider) xamlServiceProvider7);
        ((NavigableElement) label2).set_Style((Style) obj14);
        resourceExtension7.set_Key("NullStringToHyphenConverter");
        ...
        objArray8[0] = (object) bindingExtension2;
        objArray8[1] = (object) label2;
        objArray8[2] = (object) stackLayout1;
        objArray8[3] = (object) stackLayout2;
        objArray8[4] = (object) scrollView;
        objArray8[5] = (object) grid2;
        objArray8[6] = (object) noteDetailPage;
        SimpleValueTargetProvider valueTargetProvider8;
        object obj15 = (object) (valueTargetProvider8 = new SimpleValueTargetProvider(objArray8, (object) typeof (BindingExtension).GetRuntimeProperty("Converter"), (INameScope) nameScope));
        ...
        XamlTypeResolver xamlTypeResolver8 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver8, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        xamlServiceProvider8.Add(type16, (object) xamlTypeResolver8);
        xamlServiceProvider8.Add(typeof (IXmlLineInfoProvider), (object) new XmlLineInfoProvider((IXmlLineInfo) new XmlLineInfo(39, 69)));
        object obj16 = ((IMarkupExtension) resourceExtension24).ProvideValue((IServiceProvider) xamlServiceProvider8);
        bindingExtension2.set_Converter((IValueConverter) obj16);
        bindingExtension2.set_Path("ClassGroup.Nev");
        ...
        objArray9[4] = (object) grid2;
        objArray9[5] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver9 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver9, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        xamlServiceProvider9.Add(type18, (object) xamlTypeResolver9);
        xamlServiceProvider9.Add(typeof (IXmlLineInfoProvider), (object) new XmlLineInfoProvider((IXmlLineInfo) new XmlLineInfo(40, 28)));
        ...
        bindingExtension3.set_Path("ClassGroup.OktatasNevelesiFeladat.Leiras");
        ...
        objArray10[4] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver10 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver10, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        xamlServiceProvider10.Add(type20, (object) xamlTypeResolver10);
        xamlServiceProvider10.Add(typeof (IXmlLineInfoProvider), (object) new XmlLineInfoProvider((IXmlLineInfo) new XmlLineInfo(43, 24)));
        object obj20 = ((IMarkupExtension) resourceExtension26).ProvideValue((IServiceProvider) xamlServiceProvider10);
        ((NavigableElement) label4).set_Style((Style) obj20);
        translateExtension2.Text = "Note_Model_CreatingTime";
        ...
        objArray11[4] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver11 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver11, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        xamlServiceProvider11.Add(type22, (object) xamlTypeResolver11);
        xamlServiceProvider11.Add(typeof (IXmlLineInfoProvider), (object) new XmlLineInfoProvider((IXmlLineInfo) new XmlLineInfo(43, 70)));
        object obj22 = ((IMarkupExtension) translateExtension8).ProvideValue((IServiceProvider) xamlServiceProvider11);
        ...
        objArray12[4] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver12 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver12, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        xamlServiceProvider12.Add(type24, (object) xamlTypeResolver12);
        xamlServiceProvider12.Add(typeof (IXmlLineInfoProvider), (object) new XmlLineInfoProvider((IXmlLineInfo) new XmlLineInfo(44, 24)));
        ...
        bindingExtension4.set_StringFormat("{0:d}");
        bindingExtension4.set_Path("Note.CreatingTimeLocal");
        BindingBase bindingBase4 = ((IMarkupExtension<BindingBase>) bindingExtension4).ProvideValue((IServiceProvider) null);
        ((BindableObject) label5).SetBinding((BindableProperty) Label.TextProperty, bindingBase4);
        ...
        objArray13[4] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver13 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver13, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        xamlServiceProvider13.Add(type26, (object) xamlTypeResolver13);
        xamlServiceProvider13.Add(typeof (IXmlLineInfoProvider), (object) new XmlLineInfoProvider((IXmlLineInfo) new XmlLineInfo(45, 24)));
        object obj26 = ((IMarkupExtension) resourceExtension28).ProvideValue((IServiceProvider) xamlServiceProvider13);
        ((NavigableElement) label6).set_Style((Style) obj26);
        translateExtension3.Text = "Note_Model_Date";
        ...
        objArray14[4] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver14 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver14, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        xamlServiceProvider14.Add(type28, (object) xamlTypeResolver14);
        xamlServiceProvider14.Add(typeof (IXmlLineInfoProvider), (object) new XmlLineInfoProvider((IXmlLineInfo) new XmlLineInfo(45, 70)));
        object obj28 = ((IMarkupExtension) translateExtension9).ProvideValue((IServiceProvider) xamlServiceProvider14);
        ...
        objArray15[4] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver15 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver15, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        xamlServiceProvider15.Add(type30, (object) xamlTypeResolver15);
        xamlServiceProvider15.Add(typeof (IXmlLineInfoProvider), (object) new XmlLineInfoProvider((IXmlLineInfo) new XmlLineInfo(46, 24)));
        ...
        bindingExtension5.set_StringFormat("{0:d}");
        bindingExtension5.set_Path("Note.DateLocal");
        BindingBase bindingBase5 = ((IMarkupExtension<BindingBase>) bindingExtension5).ProvideValue((IServiceProvider) null);
        ((BindableObject) label7).SetBinding((BindableProperty) Label.TextProperty, bindingBase5);
        ...
        objArray16[4] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver16 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver16, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        ...
        translateExtension4.Text = "Note_Model_Teacher";
        ...
        objArray17[4] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver17 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver17, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        ...
        object obj34 = ((IMarkupExtension) translateExtension10).ProvideValue((IServiceProvider) xamlServiceProvider17);
        ...
        objArray18[1] = (object) stackLayout2;
        objArray18[2] = (object) scrollView;
        objArray18[3] = (object) grid2;
        objArray18[4] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver18 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver18, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        ...
        object obj36 = ((IMarkupExtension) resourceExtension31).ProvideValue((IServiceProvider) xamlServiceProvider18);
        ((NavigableElement) label9).set_Style((Style) obj36);
        bindingExtension6.set_Path("Note.Teacher");
        BindingBase bindingBase6 = ((IMarkupExtension<BindingBase>) bindingExtension6).ProvideValue((IServiceProvider) null);
        ((BindableObject) label9).SetBinding((BindableProperty) Label.TextProperty, bindingBase6);
        ...
        objArray19[1] = (object) stackLayout2;
        objArray19[2] = (object) scrollView;
        objArray19[3] = (object) grid2;
        objArray19[4] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver19 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver19, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        xamlServiceProvider19.Add(type38, (object) xamlTypeResolver19);
        xamlServiceProvider19.Add(typeof (IXmlLineInfoProvider), (object) new XmlLineInfoProvider((IXmlLineInfo) new XmlLineInfo(49, 24)));
        object obj38 = ((IMarkupExtension) resourceExtension32).ProvideValue((IServiceProvider) xamlServiceProvider19);
        ((NavigableElement) label10).set_Style((Style) obj38);
        translateExtension5.Text = "Note_Model_Type";
        ...
        objArray20[1] = (object) stackLayout2;
        objArray20[2] = (object) scrollView;
        objArray20[3] = (object) grid2;
        objArray20[4] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver20 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver20, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        xamlServiceProvider20.Add(type40, (object) xamlTypeResolver20);
        xamlServiceProvider20.Add(typeof (IXmlLineInfoProvider), (object) new XmlLineInfoProvider((IXmlLineInfo) new XmlLineInfo(49, 70)));
        object obj40 = ((IMarkupExtension) translateExtension11).ProvideValue((IServiceProvider) xamlServiceProvider20);
        ...
        objArray21[1] = (object) stackLayout2;
        objArray21[2] = (object) scrollView;
        objArray21[3] = (object) grid2;
        objArray21[4] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver21 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver21, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        xamlServiceProvider21.Add(type42, (object) xamlTypeResolver21);
        xamlServiceProvider21.Add(typeof (IXmlLineInfoProvider), (object) new XmlLineInfoProvider((IXmlLineInfo) new XmlLineInfo(50, 24)));
        object obj42 = ((IMarkupExtension) resourceExtension33).ProvideValue((IServiceProvider) xamlServiceProvider21);
        ((NavigableElement) label11).set_Style((Style) obj42);
        bindingExtension7.set_Path("Note.Type");
        BindingBase bindingBase7 = ((IMarkupExtension<BindingBase>) bindingExtension7).ProvideValue((IServiceProvider) null);
        ((BindableObject) label11).SetBinding((BindableProperty) Label.TextProperty, bindingBase7);
        ((ICollection<View>) ((Layout<View>) stackLayout2).get_Children()).Add((View) label11);
        ...
        objArray22[1] = (object) stackLayout2;
        objArray22[2] = (object) scrollView;
        objArray22[3] = (object) grid2;
        objArray22[4] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver22 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver22, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        xamlServiceProvider22.Add(type44, (object) xamlTypeResolver22);
        xamlServiceProvider22.Add(typeof (IXmlLineInfoProvider), (object) new XmlLineInfoProvider((IXmlLineInfo) new XmlLineInfo(51, 24)));
        object obj44 = ((IMarkupExtension) resourceExtension34).ProvideValue((IServiceProvider) xamlServiceProvider22);
        ((NavigableElement) label12).set_Style((Style) obj44);
        translateExtension6.Text = "Note_Model_Content";
        ...
        objArray23[1] = (object) stackLayout2;
        objArray23[2] = (object) scrollView;
        objArray23[3] = (object) grid2;
        objArray23[4] = (object) noteDetailPage;
        ...
        XamlTypeResolver xamlTypeResolver23 = new XamlTypeResolver((IXmlNamespaceResolver) namespaceResolver23, typeof (NoteDetailPage).GetTypeInfo().Assembly);
        xamlServiceProvider23.Add(type46, (object) xamlTypeResolver23);
        xamlServiceProvider23.Add(typeof (IXmlLineInfoProvider), (object) new XmlLineInfoProvider((IXmlLineInfo) new XmlLineInfo(51, 70)));
        object obj46 = ((IMarkupExtension) translateExtension12).ProvideValue((IServiceProvider) xamlServiceProvider23);
        label12.set_Text((string) obj46);
        ((ICollection<View>) ((Layout<View>) stackLayout2).get_Children()).Add((View) label12);
        ((BindableObject) webView).SetValue((BindableProperty) VisualElement.HeightRequestProperty, (object) 250.0);
        ...
        webView.add_Navigating(new EventHandler<WebNavigatingEventArgs>(noteDetailPage.WebView_OnNavigating));
        bindingExtension8.set_Path("Note.WebViewSource");
        BindingBase bindingBase8 = ((IMarkupExtension<BindingBase>) bindingExtension8).ProvideValue((IServiceProvider) null);
        ((BindableObject) webView).SetBinding((BindableProperty) WebView.SourceProperty, bindingBase8);
        ...
        ((BindableObject) noteDetailPage).SetValue((BindableProperty) ContentPage.ContentProperty, (object) grid2);
      }
    }

    private void __InitComponentRuntime()
    {
      Xamarin.Forms.Xaml.Extensions.LoadFromXaml<NoteDetailPage>((M0) this, typeof (NoteDetailPage));
    }
  }
}
