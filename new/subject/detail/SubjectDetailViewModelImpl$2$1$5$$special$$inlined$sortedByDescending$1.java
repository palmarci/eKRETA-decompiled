...
public final class SubjectDetailViewModelImpl$2$1$5$$special$$inlined$sortedByDescending$1<T> implements Comparator<T> {
    public final int compare(T t, T t2) {
        return ComparisonsKt__ComparisonsKt.compareValues(((Evaluation) t2).t(), ((Evaluation) t).t());
    }
}
