...
public final class TokenExpired extends AuthenticationState implements WithProfile {
    ...
    public static /* synthetic */ TokenExpired copy$default(TokenExpired tokenExpired, Profile profile, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            profile = tokenExpired.a();
        }
        return tokenExpired.a(profile);
    }

    public final TokenExpired a(Profile profile) {
        Intrinsics.checkParameterIsNotNull(profile, FirebaseContainer.Param.PROFILE);
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            return (obj instanceof TokenExpired) && Intrinsics.areEqual((Object) a(), (Object) ((TokenExpired) obj).a());
        }
        return true;
    }
    ...
    public String toString() {
        StringBuilder a2 = a.a("TokenExpired(profile=");
        a2.append(a());
        a2.append(")");
        return a2.toString();
    }
