...
public final class OmissionsPerDayViewModelImpl$toOmissionPerDayList$1$$special$$inlined$sortedByDescending$1<T> implements Comparator<T> {
    public final int compare(T t, T t2) {
        return ComparisonsKt__ComparisonsKt.compareValues(((Omission) t2).n(), ((Omission) t).n());
    }
}
