...
public final class DailyOmissionsViewModelImpl$onSelect$1 extends Lambda implements Function1<Activity, Intent> {
    public final /* synthetic */ OmissionViewModel c;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DailyOmissionsViewModelImpl$onSelect$1(OmissionViewModel omissionViewModel) {
        super(1);
        this.c = omissionViewModel;
    }

    /* renamed from: a */
    public final Intent invoke(Activity activity) {
        Intent a2 = a.a(activity, "$receiver", activity, OmissionDetailActivity.class);
        ExtensionsKt.a(a2, this.c.d());
        return a2;
    }
}
