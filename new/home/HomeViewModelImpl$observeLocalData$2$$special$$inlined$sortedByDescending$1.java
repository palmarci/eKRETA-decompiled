...
public final class HomeViewModelImpl$observeLocalData$2$$special$$inlined$sortedByDescending$1<T> implements Comparator<T> {
    public final int compare(T t, T t2) {
        return ComparisonsKt__ComparisonsKt.compareValues(((ListItem.DashboardItem) t2).b(), ((ListItem.DashboardItem) t).b());
    }
}
