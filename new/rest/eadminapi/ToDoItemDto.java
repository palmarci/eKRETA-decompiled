...
public final class ToDoItemDto {
    ...
    @c("rendszerKeszSzoveg")
    public final String systemReadyText;
    @c("teendoKotelezoDokumentum")
    public final ToDoMandatoryDocumentsListDto toDoMandatoryDocumentsList;

    public ToDoItemDto(int i2, Integer num, boolean z, String str, String str2, String str3, Integer num2, String str4, boolean z2, boolean z3, boolean z4, String str5, ToDoMandatoryDocumentsListDto toDoMandatoryDocumentsListDto, String str6) {
        a.a(str, "appellation", str2, "help", str3, "helpUrl");
        this.id = i2;
    ...
    public static /* synthetic */ ToDoItemDto copy$default(ToDoItemDto toDoItemDto, int i2, Integer num, boolean z, String str, String str2, String str3, Integer num2, String str4, boolean z2, boolean z3, boolean z4, String str5, ToDoMandatoryDocumentsListDto toDoMandatoryDocumentsListDto, String str6, int i3, Object obj) {
        ToDoItemDto toDoItemDto2 = toDoItemDto;
        int i4 = i3;
        return toDoItemDto.copy((i4 & 1) != 0 ? toDoItemDto2.id : i2, (i4 & 2) != 0 ? toDoItemDto2.documentTemplateId : num, (i4 & 4) != 0 ? toDoItemDto2.isReady : z, (i4 & 8) != 0 ? toDoItemDto2.appellation : str, (i4 & 16) != 0 ? toDoItemDto2.help : str2, (i4 & 32) != 0 ? toDoItemDto2.helpUrl : str3, (i4 & 64) != 0 ? toDoItemDto2.executiveId : num2, (i4 & 128) != 0 ? toDoItemDto2.sequence : str4, (i4 & 256) != 0 ? toDoItemDto2.isOnline : z2, (i4 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0 ? toDoItemDto2.isAutomatic : z3, (i4 & 1024) != 0 ? toDoItemDto2.isSystemReady : z4, (i4 & 2048) != 0 ? toDoItemDto2.systemReadyText : str5, (i4 & ConstantsKt.DEFAULT_BLOCK_SIZE) != 0 ? toDoItemDto2.toDoMandatoryDocumentsList : toDoMandatoryDocumentsListDto, (i4 & ConstantsKt.DEFAULT_BUFFER_SIZE) != 0 ? toDoItemDto2.label : str6);
    }
    ...
    public final ToDoItemDto copy(int i2, Integer num, boolean z, String str, String str2, String str3, Integer num2, String str4, boolean z2, boolean z3, boolean z4, String str5, ToDoMandatoryDocumentsListDto toDoMandatoryDocumentsListDto, String str6) {
        String str7 = str;
        ...
        return new ToDoItemDto(i2, num, z, str7, str8, str9, num2, str4, z2, z3, z4, str5, toDoMandatoryDocumentsListDto, str6);
    }
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof ToDoItemDto) {
                ...
                if ((this.id == toDoItemDto.id) && Intrinsics.areEqual((Object) this.documentTemplateId, (Object) toDoItemDto.documentTemplateId)) {
    ...
    public String toString() {
        StringBuilder a2 = a.a("ToDoItemDto(id=");
        a2.append(this.id);
        a2.append(", documentTemplateId=");
        a2.append(this.documentTemplateId);
        a2.append(", isReady=");
        a2.append(this.isReady);
        a2.append(", appellation=");
        a2.append(this.appellation);
        a2.append(", help=");
        a2.append(this.help);
        a2.append(", helpUrl=");
        a2.append(this.helpUrl);
        a2.append(", executiveId=");
        a2.append(this.executiveId);
        a2.append(", sequence=");
        a2.append(this.sequence);
        a2.append(", isOnline=");
        a2.append(this.isOnline);
        a2.append(", isAutomatic=");
        a2.append(this.isAutomatic);
        a2.append(", isSystemReady=");
        a2.append(this.isSystemReady);
        a2.append(", systemReadyText=");
        a2.append(this.systemReadyText);
        a2.append(", toDoMandatoryDocumentsList=");
        a2.append(this.toDoMandatoryDocumentsList);
        a2.append(", label=");
    ...
    public /* synthetic */ ToDoItemDto(int r19, java.lang.Integer r20, boolean r21, java.lang.String r22, java.lang.String r23, java.lang.String r24, java.lang.Integer r25, java.lang.String r26, boolean r27, boolean r28, boolean r29, java.lang.String r30, hu.ekreta.ellenorzo.rest.eadminapi.ToDoMandatoryDocumentsListDto r31, java.lang.String r32, int r33, kotlin.jvm.internal.DefaultConstructorMarker r34) {
        /*
            r18 = this;
            r0 = r33
            r1 = r0 & 2
        ...
        L_0x0035:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: hu.ekreta.ellenorzo.rest.eadminapi.ToDoItemDto.<init>(int, java.lang.Integer, boolean, java.lang.String, java.lang.String, java.lang.String, java.lang.Integer, java.lang.String, boolean, boolean, boolean, java.lang.String, hu.ekreta.ellenorzo.rest.eadminapi.ToDoMandatoryDocumentsListDto, java.lang.String, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }
}
