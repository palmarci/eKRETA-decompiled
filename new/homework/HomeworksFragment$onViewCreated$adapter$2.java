...
public final class HomeworksFragment$onViewCreated$adapter$2 extends Lambda implements Function2<ViewGroup, Integer, MVVMViewHolder<? super ReminderListItem>> {
    public final /* synthetic */ HomeworksFragment c;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public HomeworksFragment$onViewCreated$adapter$2(HomeworksFragment homeworksFragment) {
        super(2);
        this.c = homeworksFragment;
    }

    public final MVVMViewHolder<? super ReminderListItem> a(ViewGroup viewGroup, int i2) {
        Intrinsics.checkParameterIsNotNull(viewGroup, "parent");
        if (i2 != 0) {
            return new HomeworksFragment.ReminderItemViewHolder(this.c, viewGroup);
        }
        return new HomeworksFragment.SectionHeaderViewHolder(this.c, viewGroup);
    }
