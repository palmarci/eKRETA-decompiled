...
public final class NotesRepositoryImpl$adapter$1 {
    ...
    public NotesRepositoryImpl$adapter$1(hu.ekreta.ellenorzo.notes.NotesRepositoryImpl r3) {
        /*
            r2 = this;
            r2.c = r3
            r2.<init>()
            ...
            r2.f5875a = r3
            k.b.h0.b<hu.ekreta.ellenorzo.profile.Profile> r3 = r2.f5875a
            kotlin.reflect.KProperty1 r0 = hu.ekreta.ellenorzo.notes.NotesRepositoryImpl$adapter$1$notesObservable$1.INSTANCE
        ...
        L_0x001d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: hu.ekreta.ellenorzo.notes.NotesRepositoryImpl$adapter$1.<init>(hu.ekreta.ellenorzo.notes.NotesRepositoryImpl):void");
    }

    public final n<List<Note>> a(Profile profile) {
        Intrinsics.checkParameterIsNotNull(profile, FirebaseContainer.Param.PROFILE);
        this.f5875a.a(profile);
        a<List<Note>> aVar = this.b;
        Intrinsics.checkExpressionValueIsNotNull(aVar, "notesObservable");
        return aVar;
    }

    public final n<Note> a(Note note) {
        Intrinsics.checkParameterIsNotNull(note, "note");
        return this.c.a().a(note);
    }
}
