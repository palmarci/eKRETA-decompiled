...
public final class NotesViewModelImpl$toListItems$1$$special$$inlined$sortedByDescending$1<T> implements Comparator<T> {
    public final int compare(T t, T t2) {
        return ComparisonsKt__ComparisonsKt.compareValues(((Note) t2).j(), ((Note) t).j());
    }
}
