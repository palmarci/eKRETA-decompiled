...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u00012\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00040\u0001H\n¢\u0006\u0002\b\u0005"}, d2 = {"<anonymous>", "", "Lhu/ekreta/ellenorzo/addresseeselector/model/AddresseeType;", "listOfAddressableType", "Lhu/ekreta/ellenorzo/rest/eadminapi/AddresseeTypeDto;", "apply"}, k = 3, mv = {1, 1, 15})
/* compiled from: AddresseeSelectorServiceImpl.kt */
public final class AddresseeSelectorServiceImpl$fetchAddressableTypeList$1<T, R> implements h<T, R> {
    public static final AddresseeSelectorServiceImpl$fetchAddressableTypeList$1 INSTANCE = new AddresseeSelectorServiceImpl$fetchAddressableTypeList$1();

    /* renamed from: a */
    public final List<AddresseeType> apply(List<AddresseeTypeDto> list) {
        String str;
        String str2;
        Intrinsics.checkParameterIsNotNull(list, "listOfAddressableType");
