...
public final class AddresseeSelectorViewModelImpl$fetchClassMastersAddressList$2 extends Lambda implements Function1<List<? extends EmployeeDetails>, Unit> {
    public final /* synthetic */ AddresseeSelectorViewModelImpl c;
    public final /* synthetic */ AddresseeType e;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AddresseeSelectorViewModelImpl$fetchClassMastersAddressList$2(AddresseeSelectorViewModelImpl addresseeSelectorViewModelImpl, AddresseeType addresseeType) {
        super(1);
    ...
    public final void a(List<EmployeeDetails> list) {
        ...
        for (EmployeeDetails access$createListItemFromClassMasterAddressee : list) {
            arrayList.add(this.c.b(access$createListItemFromClassMasterAddressee, this.e));
        }
