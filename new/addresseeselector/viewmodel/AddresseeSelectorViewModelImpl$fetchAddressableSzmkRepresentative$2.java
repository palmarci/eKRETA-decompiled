...
public final class AddresseeSelectorViewModelImpl$fetchAddressableSzmkRepresentative$2 extends Lambda implements Function1<List<? extends GuardianEAdmin>, Unit> {
    public final /* synthetic */ AddresseeSelectorViewModelImpl c;
    public final /* synthetic */ AddresseeType e;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AddresseeSelectorViewModelImpl$fetchAddressableSzmkRepresentative$2(AddresseeSelectorViewModelImpl addresseeSelectorViewModelImpl, AddresseeType addresseeType) {
        super(1);
    ...
    public final void a(List<GuardianEAdmin> list) {
        ...
        for (GuardianEAdmin access$createListItemFromSzmkRepresentative : list) {
            arrayList.add(this.c.b(access$createListItemFromSzmkRepresentative, this.e));
        }
