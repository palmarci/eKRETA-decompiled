...
public final class AddresseeSelectorViewModelImpl$fetchAdministratorsAddressList$2 extends Lambda implements Function1<List<? extends EmployeeDetails>, Unit> {
    public final /* synthetic */ AddresseeSelectorViewModelImpl c;
    public final /* synthetic */ AddresseeType e;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AddresseeSelectorViewModelImpl$fetchAdministratorsAddressList$2(AddresseeSelectorViewModelImpl addresseeSelectorViewModelImpl, AddresseeType addresseeType) {
        super(1);
    ...
    public final void a(List<EmployeeDetails> list) {
        ...
        for (EmployeeDetails access$createListItemFromAdministratorsAddressee : list) {
            arrayList.add(this.c.a(access$createListItemFromAdministratorsAddressee, this.e));
        }
