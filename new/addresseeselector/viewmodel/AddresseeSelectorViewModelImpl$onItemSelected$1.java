...
public final class AddresseeSelectorViewModelImpl$onItemSelected$1 extends Lambda implements Function1<d, Unit> {
    public final /* synthetic */ Intent c;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AddresseeSelectorViewModelImpl$onItemSelected$1(Intent intent) {
        super(1);
        this.c = intent;
    }
