...
public final class AddresseeSelectorViewModelImpl$fetchDirectorsAddressList$3 extends Lambda implements Function1<Throwable, Unit> {
    public final /* synthetic */ AddresseeSelectorViewModelImpl c;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AddresseeSelectorViewModelImpl$fetchDirectorsAddressList$3(AddresseeSelectorViewModelImpl addresseeSelectorViewModelImpl) {
        super(1);
