...
public final class AddresseeSelectorViewModelImpl$fetchAddressableClasses$3 extends Lambda implements Function1<Throwable, Unit> {
    public final /* synthetic */ AddresseeSelectorViewModelImpl c;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AddresseeSelectorViewModelImpl$fetchAddressableClasses$3(AddresseeSelectorViewModelImpl addresseeSelectorViewModelImpl) {
        super(1);
