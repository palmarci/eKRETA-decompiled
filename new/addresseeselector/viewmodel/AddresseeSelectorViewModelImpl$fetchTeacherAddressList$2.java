...
public final class AddresseeSelectorViewModelImpl$fetchTeacherAddressList$2 extends Lambda implements Function1<List<? extends EmployeeDetails>, Unit> {
    public final /* synthetic */ AddresseeSelectorViewModelImpl c;
    public final /* synthetic */ AddresseeType e;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AddresseeSelectorViewModelImpl$fetchTeacherAddressList$2(AddresseeSelectorViewModelImpl addresseeSelectorViewModelImpl, AddresseeType addresseeType) {
        super(1);
    ...
    public final void a(List<EmployeeDetails> list) {
        ...
        for (EmployeeDetails access$createListItemFromTeacherAddressee : list) {
            arrayList.add(this.c.d(access$createListItemFromTeacherAddressee, this.e));
        }
