...
public final class TimeTableItemDetailViewModelImpl$loadAnnouncedTest$1<T, R> implements h<T, q<? extends R>> {
    ...
    public final n<List<AnnouncedTest>> apply(Profile profile) {
        ...
        return timeTableItemDetailViewModelImpl.a(timeTableItemDetailViewModelImpl.A.h(profile));
    }
}
