...
public final /* synthetic */ class NewMessageActivity$onCreate$1 extends FunctionReference implements Function1<Attachment, Unit> {
    public NewMessageActivity$onCreate$1(NewMessageViewModel newMessageViewModel) {
        super(1, newMessageViewModel);
    }

    public final void a(Attachment attachment) {
        Intrinsics.checkParameterIsNotNull(attachment, "p1");
        ((NewMessageViewModel) this.receiver).a(attachment);
    }
