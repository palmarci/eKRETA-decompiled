...
public final class NewMessageViewModelImpl$startSendMessageRequest$2 extends Lambda implements Function1<Throwable, Unit> {
    public final /* synthetic */ NewMessageViewModelImpl c;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public NewMessageViewModelImpl$startSendMessageRequest$2(NewMessageViewModelImpl newMessageViewModelImpl) {
        super(1);
