...
public final class DataBindingViewModel$showSnackbar$1 extends Lambda implements Function1<d, Unit> {
    public final /* synthetic */ int c;
    public final /* synthetic */ int e;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DataBindingViewModel$showSnackbar$1(int i2, int i3) {
        super(1);
        this.c = i2;
        this.e = i3;
    }
    ...
    public final void a(d dVar) {
        ...
        ExtensionsKt.a(dVar, this.c, this.e);
    }
