...
public final class NoticeBoardFragment$SectionHeaderViewHolder$$special$$inlined$observable$1 extends ObservableProperty<NoticeBoardViewModel.ListItem> {
    public final /* synthetic */ NoticeBoardFragment.SectionHeaderViewHolder c;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public NoticeBoardFragment$SectionHeaderViewHolder$$special$$inlined$observable$1(Object obj, Object obj2, NoticeBoardFragment.SectionHeaderViewHolder sectionHeaderViewHolder) {
        super(obj2);
    ...
    public void afterChange(KProperty<?> kProperty, NoticeBoardViewModel.ListItem listItem, NoticeBoardViewModel.ListItem listItem2) {
        ...
        if (!(listItem3 instanceof NoticeBoardViewModel.ListItem.SectionHeader)) {
            listItem3 = null;
        }
        NoticeBoardViewModel.ListItem.SectionHeader sectionHeader = (NoticeBoardViewModel.ListItem.SectionHeader) listItem3;
