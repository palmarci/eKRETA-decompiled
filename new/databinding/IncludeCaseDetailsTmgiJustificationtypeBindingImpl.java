...
public class IncludeCaseDetailsTmgiJustificationtypeBindingImpl extends IncludeCaseDetailsTmgiJustificationtypeBinding {
    ...
    public IncludeCaseDetailsTmgiJustificationtypeBindingImpl(h.l.f r9, android.view.View[] r10) {
        /*
            r8 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: hu.ekreta.ellenorzo.databinding.IncludeCaseDetailsTmgiJustificationtypeBindingImpl.<init>(h.l.f, android.view.View[]):void");
    }
