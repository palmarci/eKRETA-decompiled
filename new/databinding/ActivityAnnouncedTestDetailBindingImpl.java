...
public class ActivityAnnouncedTestDetailBindingImpl extends ActivityAnnouncedTestDetailBinding {
    ...
    static {
        ...
        M.put(R.id.subject_caption, 14);
        M.put(R.id.subject_divider, 15);
        M.put(R.id.type_caption, 16);
        M.put(R.id.type_divider, 17);
        M.put(R.id.name_caption, 18);
        M.put(R.id.name_divider, 19);
        M.put(R.id.date_caption, 20);
        M.put(R.id.room_divider, 21);
        M.put(R.id.teacher_caption, 22);
        M.put(R.id.teacher_divider, 23);
        M.put(R.id.record_date_caption, 24);
    }

    /* JADX WARNING: Illegal instructions before constructor call */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public ActivityAnnouncedTestDetailBindingImpl(h.l.f r30, android.view.View r31) {
        /*
            r29 = this;
            r2 = r29
            r1 = r31
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: hu.ekreta.ellenorzo.databinding.ActivityAnnouncedTestDetailBindingImpl.<init>(h.l.f, android.view.View):void");
    }
    ...
    public void V1() {
        ...
        AnnouncedTestDetailViewModel announcedTestDetailViewModel = this.I;
        String str8 = null;
        if ((511 & j2) != 0) {
            String v0 = ((j2 & 265) == 0 || announcedTestDetailViewModel == null) ? null : announcedTestDetailViewModel.v0();
            str5 = ((j2 & 259) == 0 || announcedTestDetailViewModel == null) ? null : announcedTestDetailViewModel.p();
            String d1 = ((j2 & 385) == 0 || announcedTestDetailViewModel == null) ? null : announcedTestDetailViewModel.d1();
            String j3 = ((j2 & 261) == 0 || announcedTestDetailViewModel == null) ? null : announcedTestDetailViewModel.j();
            String h2 = ((j2 & 289) == 0 || announcedTestDetailViewModel == null) ? null : announcedTestDetailViewModel.h();
            String m2 = ((j2 & 321) == 0 || announcedTestDetailViewModel == null) ? null : announcedTestDetailViewModel.m();
            if (!((j2 & 273) == 0 || announcedTestDetailViewModel == null)) {
                str8 = announcedTestDetailViewModel.getDescription();
            }
            str = v0;
            str6 = str8;
            str4 = d1;
        ...
        if ((j2 & 259) != 0) {
            this.A.setVisibility(BindingConverters.a(str5));
            this.B.setVisibility(BindingConverters.a(str5));
            a.a(this.C, (CharSequence) str5);
            this.C.setVisibility(BindingConverters.a(str5));
        }
        if ((j2 & 273) != 0) {
            a.a(this.D, (CharSequence) str6);
        }
        if ((j2 & 385) != 0) {
            a.a(this.E, (CharSequence) str4);
        }
        if ((261 & j2) != 0) {
    ...
    public void a(AnnouncedTestDetailViewModel announcedTestDetailViewModel) {
        a(0, (i) announcedTestDetailViewModel);
        this.I = announcedTestDetailViewModel;
        synchronized (this) {
            this.K |= 1;
        }
        c(88);
    ...
    public boolean c(int i2, Object obj) {
        ...
        a((AnnouncedTestDetailViewModel) obj);
        return true;
    }
