...
public class IncludeCaseDetailsReasonBindingImpl extends IncludeCaseDetailsReasonBinding {
    ...
    public IncludeCaseDetailsReasonBindingImpl(h.l.f r9, android.view.View[] r10) {
        /*
            r8 = this;
            ...
            r0 = 0
            r9.setTag(r0)
            android.webkit.WebView r9 = r8.A
            r9.setTag(r0)
            r8.a((android.view.View[]) r10)
            r8.a2()
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: hu.ekreta.ellenorzo.databinding.IncludeCaseDetailsReasonBindingImpl.<init>(h.l.f, android.view.View[]):void");
    }
    ...
    public void V1() {
        ...
        if ((j2 & 3) != 0) {
            ...
            WebViewBindings.Companion.a(this.A, str);
        }
    }
