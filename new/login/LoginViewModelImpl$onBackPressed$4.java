...
public final class LoginViewModelImpl$onBackPressed$4 extends Lambda implements Function1<Throwable, Unit> {
    public final /* synthetic */ LoginViewModelImpl c;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LoginViewModelImpl$onBackPressed$4(LoginViewModelImpl loginViewModelImpl) {
        super(1);
