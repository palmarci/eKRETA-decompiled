...
public final class LoginViewModelImpl$startForgottenPasswordActivity$1 extends Lambda implements Function1<Activity, Intent> {
    ...
    public LoginViewModelImpl$startForgottenPasswordActivity$1(LoginViewModelImpl loginViewModelImpl) {
        super(1);
    ...
    public final Intent invoke(Activity activity) {
        ...
        return new Intent("android.intent.action.VIEW", Uri.parse(this.c.u.getString(R.string.urlForgottenPassword)));
    }
}
