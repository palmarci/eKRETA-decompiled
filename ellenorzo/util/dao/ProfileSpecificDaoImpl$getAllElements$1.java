...
/* renamed from: hu.ekreta.ellenorzo.util.dao.ProfileSpecificDaoImpl$getAllElements$1 */
/* compiled from: ProfileSpecificDaoImpl.kt */
public final class ProfileSpecificDaoImpl$getAllElements$1<T, R> implements C4675h<T, R> {

    /* renamed from: c */
    public final /* synthetic */ ProfileSpecificDaoImpl f15391c;

    public ProfileSpecificDaoImpl$getAllElements$1(ProfileSpecificDaoImpl profileSpecificDaoImpl) {
        this.f15391c = profileSpecificDaoImpl;
    }
    ...
    public final List<TModel> apply(List<? extends TRealmClass> list) {
        ...
        while (it.hasNext()) {
            ...
            ProfileSpecificDaoImpl profileSpecificDaoImpl = this.f15391c;
