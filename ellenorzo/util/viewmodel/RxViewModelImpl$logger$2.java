...
/* renamed from: hu.ekreta.ellenorzo.util.viewmodel.RxViewModelImpl$logger$2 */
/* compiled from: RxViewModelImpl.kt */
public final class RxViewModelImpl$logger$2 extends Lambda implements Function0<C5620b> {

    /* renamed from: c */
    public final /* synthetic */ RxViewModelImpl f15485c;

    public RxViewModelImpl$logger$2(RxViewModelImpl rxViewModelImpl) {
        this.f15485c = rxViewModelImpl;
        super(0);
    }

    public final C5620b invoke() {
        return C5621c.m18583a(this.f15485c.getClass());
    }
}
