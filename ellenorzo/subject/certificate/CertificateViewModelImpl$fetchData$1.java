...
/* renamed from: hu.ekreta.ellenorzo.subject.certificate.CertificateViewModelImpl$fetchData$1 */
/* compiled from: CertificateViewModelImpl.kt */
public final class CertificateViewModelImpl$fetchData$1<T, R> implements C4675h<T, R> {

    /* renamed from: c */
    public final /* synthetic */ CertificateViewModelImpl f14935c;

    public CertificateViewModelImpl$fetchData$1(CertificateViewModelImpl certificateViewModelImpl) {
        this.f14935c = certificateViewModelImpl;
    }

    /* renamed from: a */
    public final List<CertificationListItem> apply(List<Evaluation> list) {
        Intrinsics.checkParameterIsNotNull(list, "it");
        return CertificateViewModelImpl.access$convertAndAddHeaders(this.f14935c, list);
    }
}
