...
/* renamed from: hu.ekreta.ellenorzo.subject.certificate.quarterly.QuarterlyViewModelImpl$fetchData$1 */
/* compiled from: QuarterlyViewModelImpl.kt */
public final class QuarterlyViewModelImpl$fetchData$1<T, R> implements C4675h<T, R> {

    /* renamed from: c */
    public final /* synthetic */ QuarterlyViewModelImpl f14993c;

    public QuarterlyViewModelImpl$fetchData$1(QuarterlyViewModelImpl quarterlyViewModelImpl) {
        this.f14993c = quarterlyViewModelImpl;
    }

    /* renamed from: a */
    public final List<CertificationListItem> apply(List<Evaluation> list) {
        Intrinsics.checkParameterIsNotNull(list, "it");
        return this.f14993c.mo15862b(list);
    }
}
