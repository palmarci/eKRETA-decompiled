...
/* renamed from: hu.ekreta.ellenorzo.subject.detail.SubjectDetailViewModelImpl$2$1$5$$special$$inlined$sortedByDescending$1 */
/* compiled from: Comparisons.kt */
public final class C4381xf1fe34d8<T> implements Comparator<T> {
    public final int compare(T t, T t2) {
        return ComparisonsKt__ComparisonsKt.compareValues(((Evaluation) t2).mo12610t(), ((Evaluation) t).mo12610t());
    }
}
