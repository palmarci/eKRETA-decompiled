...
/* renamed from: hu.ekreta.ellenorzo.subject.averages.AveragesViewModelImpl$fetchData$1 */
/* compiled from: AveragesViewModelImpl.kt */
public final class AveragesViewModelImpl$fetchData$1<T, R> implements C4675h<T, R> {

    /* renamed from: c */
    public final /* synthetic */ AveragesViewModelImpl f14925c;

    public AveragesViewModelImpl$fetchData$1(AveragesViewModelImpl averagesViewModelImpl) {
        this.f14925c = averagesViewModelImpl;
    }

    /* renamed from: a */
    public final List<AveragesListItem> apply(List<Subject> list) {
        Intrinsics.checkParameterIsNotNull(list, "it");
        return this.f14925c.mo15800b(list);
    }
}
