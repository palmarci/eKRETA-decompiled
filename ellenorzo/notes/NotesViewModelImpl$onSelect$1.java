...
/* renamed from: hu.ekreta.ellenorzo.notes.NotesViewModelImpl$onSelect$1 */
...
public final class NotesViewModelImpl$onSelect$1 extends Lambda implements Function1<Activity, Intent> {
    ...
    /* renamed from: c */
    public final /* synthetic */ ListItem f14123c;

    public NotesViewModelImpl$onSelect$1(ListItem listItem) {
        this.f14123c = listItem;
        super(1);
    }

    /* renamed from: a */
    public final Intent invoke(Activity activity) {
        Intent a = C0082a.m88a(activity, "$receiver", activity, NoteDetailsActivity.class);
        ExtensionsKt.m14642a(a, ((Note) this.f14123c).mo13646a());
        return a;
    }
}
