...
/* renamed from: hu.ekreta.ellenorzo.cases.CasesViewModelImpl$onSelect$1 */
...
public final class CasesViewModelImpl$onSelect$1 extends Lambda implements Function1<Activity, Intent> {
    ...
    /* renamed from: c */
    public final /* synthetic */ BaseCase f11345c;

    public CasesViewModelImpl$onSelect$1(BaseCase baseCase) {
        this.f11345c = baseCase;
        super(1);
    }

    /* renamed from: a */
    public final Intent invoke(Activity activity) {
        Intent a = C0082a.m88a(activity, "$receiver", activity, CaseDetailsActivity.class);
        ExtensionsKt.m14637a(a, this.f11345c);
        return a;
    }
}
