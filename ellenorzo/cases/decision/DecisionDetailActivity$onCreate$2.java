...
/* renamed from: hu.ekreta.ellenorzo.cases.decision.DecisionDetailActivity$onCreate$2 */
/* compiled from: DecisionDetailActivity.kt */
public final /* synthetic */ class DecisionDetailActivity$onCreate$2 extends FunctionReference implements Function1<Attachment, Unit> {
    public DecisionDetailActivity$onCreate$2(DecisionDetailViewModel decisionDetailViewModel) {
        super(1, decisionDetailViewModel);
    }

    /* renamed from: a */
    public final void mo11713a(Attachment attachment) {
        Intrinsics.checkParameterIsNotNull(attachment, "p1");
        ((DecisionDetailViewModel) this.receiver).onSelect(attachment);
    }
