...
/* renamed from: hu.ekreta.ellenorzo.cases.tmgi.TmgiFormFragment$onViewCreated$3 */
/* compiled from: TmgiFormFragment.kt */
public final /* synthetic */ class TmgiFormFragment$onViewCreated$3 extends FunctionReference implements Function1<Attachment, Unit> {
    public TmgiFormFragment$onViewCreated$3(TmgiFormViewModel tmgiFormViewModel) {
        super(1, tmgiFormViewModel);
    }

    /* renamed from: a */
    public final void mo12119a(Attachment attachment) {
        Intrinsics.checkParameterIsNotNull(attachment, "p1");
        ((TmgiFormViewModel) this.receiver).mo12147a(attachment);
    }
